...
def collect_nm_embed_rows(
    ...
    complex_fields_info: dict[str, dict],
...
def fetch_1n_embeds(
    row: dict[str, Any], complex_fields_info: dict[str, dict]
...
def export_events(
    ...
    complex_fields_info: dict[str, dict] = fetch_complex_fields_info(dataset_table)
