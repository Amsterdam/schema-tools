...
class TestDjangoModelFactory:
    ...
    def test_model_factory_fields(self, afval_dataset) -> None:
        ...
        assert meta.app_label == f"{afval_dataset.schema.id}_{afval_dataset.default_version}"
    ...
    def test_temporal_subfields_are_skipped(self, verblijfsobjecten_dataset):
        ...
        begin_geldigheid_field = model_dict["verblijfsobjecten"]._meta.get_field(
            "begin_geldigheid"
        )
    ...
    def test_non_composite_string_identifiers_use_slash_constraints(
        ...
        with pytest.raises(
            ...
            match=(
                ...
                r' check constraint "parkeervakken_v1_parkeervakken_v1_id_not_contains_slash".*'
            ),
        ):
